...
I'm Joel "Jaykul" Bennett. 10x PowerShell MVP. Occupationally I'm a programmer. My business cards (if I had any) say "Senior DevOps Engineer" and sometimes "Software Architect" but at the end of the day, I'm a Battle Faction hacker. It's important that you understand that as we get into our subject for today...

## This talk is about writing survivable code, which to me means two things:

1. Designing: Write commands which make sense and work together
2. Error Handling: Collecting exceptions, and logging errors

I want to be clear about one thing: I can promise you, up front, that not all of my own code is bullet-proof.

The truth is that in my public (GitHub) code, I only rarely write things that really **need** to be bullet-proof, and as a result, if you look me up on github, you're not going to find all of these exception handling and logging practices followed. That tends to be a side-effect of writing modules for colors and prompts, where errors are unlikely, and not critical in any case. ;)
...
I know I said I was Battle Faction ... but really I'm never quite happy with a module until the commands can pipe into each other, and the number of nouns has been reduced as far as I can get it. The key, of course, is to thinking about how your command will be used, and design to make that easier. It's a really good practice to start by writing the help examples and tests before you ever start implementing anything -- so you can get a feel for how you expect the command to be used.
